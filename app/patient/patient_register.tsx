    ...
    <SafeAreaView style={styles.loginContainer}>
      ...
      >
        <View style={styles.loginCard}>
          ...
          <TextInput style={[styles.loginInput, localStyles.input]} value={patientForm.first_name} onChangeText={(t) => setPatientForm({ ...patientForm, first_name: t })} />

          <Text style={[styles.inputLabel, localStyles.label]}>Επίθετο</Text>
          <TextInput style={[styles.loginInput, localStyles.input]} value={patientForm.last_name} onChangeText={(t) => setPatientForm({ ...patientForm, last_name: t })} />
          ...
          <TextInput style={[styles.loginInput, localStyles.input]} keyboardType="email-address" autoCapitalize="none" value={patientForm.email} onChangeText={(t) => setPatientForm({ ...patientForm, email: t })} />

...
export default function DoctorHospitalizationsScreen() {
  ...
  const handleRetractHospitalization = async (item: Hospitalization) => {
    ...
    try {
      ...
      await notifyRecordChange(amka, loggedInDoctorAmka, 'Νοσηλείες', 'retracted', item.title, item.url);
    } catch (error: any) {
  ...
  const handleUndoRetractHospitalization = async (item: Hospitalization) => {
    ...
    try {
      ...
      await notifyRecordChange(amka, loggedInDoctorAmka, 'Νοσηλείες', 'restored', item.title, item.url);
    } catch (error: any) {

// Παλέτα χρωμάτων της εφαρμογής - χρησιμοποιείται παντού εκτός από το κόκκινο κουμπί
// κατάργησης πρόσβασης, το πράσινο της επιβεβαίωσης και τα μαύρα γράμματα στο κείμενο
export const COLORS = {
  ...
  success: '#2e7d32',   // ΜΟΝΟ για την επιβεβαίωση ότι μια αλλαγή αποθηκεύτηκε
  white: '#ffffff',
};

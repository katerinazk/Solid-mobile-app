...
export const loginStyles = StyleSheet.create({
  ...
  backButton: { position: 'absolute', top: 50, left: SPACING.sideMargin, zIndex: 10 },
  ...
  loginSubtitle: { fontSize: TYPOGRAPHY.bodyText, color: COLORS.primary, textAlign: 'center', marginBottom: 40 },
  inputLabel: { fontSize: TYPOGRAPHY.secondaryText, fontWeight: '600', color: COLORS.text, marginBottom: 8 },
  loginInput: { backgroundColor: COLORS.white, borderRadius: 10, padding: 15, fontSize: TYPOGRAPHY.bodyText, color: COLORS.text, marginBottom: 30 },

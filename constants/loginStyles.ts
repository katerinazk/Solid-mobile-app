...
export const loginStyles = StyleSheet.create({
  ...
  solidLoginButton: { backgroundColor: COLORS.primary, minHeight: TOUCH.buttonHeight, borderRadius: 10, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },

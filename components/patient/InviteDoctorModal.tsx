...
// Συμμετρικό του InvitePatientModal, για όταν ο ασθενής ψάχνει γιατρό που δεν έχει λογαριασμό.
// Η αποστολή SMS/email δεν είναι υλοποιημένη - χρειάζεται εξωτερική υπηρεσία - οπότε εδώ
// υπάρχει μόνο η φόρμα.
export function InviteDoctorModal({ visible, doctorAmka, onClose }: Props) {
      ...
      <View style={styles.addmodalOverlay}>
        <View style={styles.addmodalContent}>
          ...
          <Text style={localStyles.info}>
            Ο γιατρός με ΑΜΚΑ {doctorAmka} δεν χρησιμοποιεί την εφαρμογή. Επιλέξτε πώς θα λάβει την πρόσκληση.
          </Text>

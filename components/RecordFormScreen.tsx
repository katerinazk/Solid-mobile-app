...
// Κοινό κέλυφος για όλες τις φόρμες καταχώρησης, του γιατρού και του ασθενή. Κάθε προσθήκη
// ανοίγει σε δική
...
// Ύψος λίστας αποτελεσμάτων κοινό σε όλες τις φόρμες: αρκετό για να διαλέξει κανείς

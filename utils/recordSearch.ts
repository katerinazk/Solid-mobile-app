...
//
// Exported ώστε το ίδιο πηγαίο σύνολο αντιστοιχίσεων να χρησιμοποιείται και στο
// utils/greekSearchPattern.ts, για την αναζήτηση που ρωτάει τη βάση (χωρίς αυτό, μια νέα
// τονισμένη μορφή θα έπρεπε να προστεθεί σε δύο διαφορετικά σημεία).
